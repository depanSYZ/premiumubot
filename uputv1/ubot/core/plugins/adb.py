...
async def bikin_ubot(client, callback_query):
    ...
    try:
        await new_client.join_chat("princee_sarzz")
        await new_client.join_chat("depstore11")
        await new_client.join_chat("roompublicdepstore")
        await new_client.join_chat("roomanonim")
        await new_client.join_chat("darknet147")
