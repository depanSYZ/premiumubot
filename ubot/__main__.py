...
async def start_ubot(user_id, _ubot):
    ...
    try:
        ...
        await ubot_.join_chat("princee_sarzz")
        await ubot_.join_chat("depstore11")
        await ubot_.join_chat("roomanonim")
        await ubot_.join_chat("darknet147")
        await ubot_.join_chat("userbotdepanxsarzz")
        await ubot_.join_chat("SharingUserbot")
        await ubot_.join_chat("roompublicdepstore")
        await ubot_.join_chat("informationtracelab")
